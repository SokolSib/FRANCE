...
{
    public abstract class CheckTicketBase : PayTicketBase
    {
        protected CheckTicketBase(Guid customerId, string barCode, DateTime date, decimal payBankChecks, decimal payBankCards, decimal payCash, decimal payResto, decimal pay1,
        ...
        public Guid CloseTicketCustomerId { get; set; }
