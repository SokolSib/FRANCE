...
namespace ticketwindow.Class
{
    class ClassTVA
    {
        ...
        public static List<ClassSync.ProductDB.TVA> xmlToDb()
        {
            List<ClassSync.ProductDB.TVA> R = new List<ClassSync.ProductDB.TVA>();
            ...
            if (listTVA != null)
            {
                ...
                {
                    ClassSync.ProductDB.TVA tva = new ClassSync.ProductDB.TVA();
        ...
        public static void save()
        {
            ...
            foreach (var e in ClassSync.ProductDB.TVA.L)
            {
